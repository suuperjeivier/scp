...
public class DatabaseGateway {	
	...
	public DatabaseGateway(){
		...
		this.setDbServerHostname("localhost");//local 10.30.1.31//db_serv172.16.21.198
		this.setDbServerPort("3306");
		this.setDbName("db_sicae");
//		this.bdUserName = "prueba";
		this.setBdUserName("root");//yhernandeza//db_erp:appuser
//		this.bdPassword = "123456";
		this.setBdPassword("root");//yhernandeza//c4tabasco
