...
public class DatabaseGateway3 {	
	...
	public DatabaseGateway3(){
		...
		this.setDbName("bitacoraCAT");
//		this.bdUserName = "prueba";
		this.setBdUserName("prueba");//yhernandeza//appuser
//		this.bdPassword = "123456";
		this.setBdPassword("123456");//yhernandeza//c4tabasco
