...
<meta name="description"
	content="Pagina para Configuración de menús por perfil" />
					...
					<div class="modal-content">
						...
						<form id="form<c:out value="${compTitleSing}"/>">
							<div class="modal-body">
								...
								<div class="form-group row">
									<label for="field8" class="col-3 col-form-label">MENÚ</label> <select
								...
								<div class="form-group row">
									<label for="field3" class="col-3 col-form-label">SUBMENÚ</label>
						...
						<table id="tb_lista<c:out value="${compTitle}"/>"
							...
							<thead>
								<tr>
									...
									<th><i class="fa fa-list" aria-hidden="true"></i> MENÚ:</th>
									<th><i class="fa fa-list" aria-hidden="true"></i> SUBMENÚ:
									</th>
