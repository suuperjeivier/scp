					...
					<div class="modal-content">
						...
						<form id="form<c:out value="${compTitleSing}"/>">
							<div class="modal-body">
								...
								<div class="form-group row">
									<label for="field3" class="col-2 col-form-label">DESCRIPCIÓN</label>
									<input type="text" class="col-8 form-control" name="field3"
										id="field3"
										placeholder="Descripción del <c:out value="${compTitleSing}"/>">
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									<label for="field5" class="col-2 col-form-label">ÍCONO</label>
									<input type="text" class="col-8 form-control" name="field5"
										id="field5"
										placeholder="Ícono del <c:out value="${compTitleSing}"/>">
								</div>
								<div class="form-group row">
						...
						<table id="tb_lista<c:out value="${compTitle}"/>"
							...
							<thead>
								<tr>
									...
									<td><i class="fa fa-list" aria-hidden="true"></i> ÍCONO:</td>
