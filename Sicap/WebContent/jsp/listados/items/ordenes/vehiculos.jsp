					...
					<div class="modal-content">
						...
						<form id="form<c:out value="${compTitleSing}"/>">
							<div class="modal-body">
								...
								<div class="form-group row">
									<label for="field7" class="col-2 col-form-label">Placas
									</label> <input type="text" class="col-6 form-control" name="field7"
										id="field7"
										placeholder="Placas del <c:out value="${compTitleSing}"/>"
										required>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									<label for="field9" class="col-2 col-form-label">Núm.
										póliza</label> <input type="text" class="col-6 form-control"
										name="field9" id="field9"
										placeholder="Poliza del <c:out value="${compTitleSing}"/>"
										required>
								</div>
								<div class="form-group row">
									<label for="field10" class="col-2 col-form-label">Activo</label>
									<input type="text" class="col-6 form-control" name="field10"
										id="field10"
								...
								<c:forEach var="row" items="${items}">
									<tr>
										...
										<td><a role="button"
											...
											data-field10="<c:out value='${row.activo}' escapeXml="false" />"><i
												class="fa fa-pencil"
