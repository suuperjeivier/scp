					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-2 col-xs-2 col-lg-2">
									<fieldset>
										<label class="texto-azul-bold">GÉNERO:</label>
								...
								<div class="col-md-3 col-xs-3 col-lg-3">
									<label for="grupoSanguineo" class="texto-azul-bold">GRUPO
										SANGUÍNEO:</label> <select class="form-control" id="grupoSanguineo"
										name="grupoSanguineo">
							...
							<div class="row">
								...
								<div class="col-md-4 col-xs-4 col-lg-4">
									<label for="correoe" class="texto-azul-bold">CORREO
										ELECTRÓNICO:</label> <input type="email" id="correoe" name="correoe"
							...
							<div class="row">
								<div class="col-md-3 col-xs-3 col-lg-3">
									<label for="ultimoGradoEmpleado" class="texto-azul-bold">ÚLTIMO
							...
							<div class="row">
								...
								<div class="col-md-6 col-xs-6 col-lg-6">
									<label for="fotoEmpleado" class="texto-azul-bold">FOTOGRAFÍA:</label>
